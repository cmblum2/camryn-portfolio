...
export const entries = [
  ...
  { id: 'voice', root: 'lab', rootLabel: 'research lab', label: 'voice AI', lenses: ['AI', 'ML'],
    ...
    metric: 'full-duplex', mlabel: 'UW research lab · voice AI · co-authored',
    headline: 'Voice-first lab assistant (SteMy)',
    narrative: "A separate engagement from the FHI internship — at a UW–Madison research lab. I co-authored the voice layer of SteMy, a hands-free AI assistant that lets a scientist run bench workflows by voice: OpenAI Realtime full-duplex speech, function-calling into lab tools, and a spoken confirmation gate before any real action. Different domain, different team — my part was the voice and tool-dispatch flow.",
    skills: ['Voice AI (OpenAI Realtime)', 'Function-calling', 'Human-in-the-loop safety', 'Real-time systems', 'Research engineering'],
    tech: [
      "Voice — OpenAI Realtime API for full-duplex speech (listen and talk at once), streaming into function-calls against lab tools, with turn-taking and barge-in handled.",
      "Safety — a spoken confirmation gate before any side-effecting action: the model proposes, the human commits, so it can't act on a mishearing.",
      "Context — the broader assistant (team-built) also has proactive alarms, cross-run reproducibility checks, free-form dictation, and a research-diary, with ~367 tests passing; my contribution was the voice and tool-dispatch flow.",
    ],
