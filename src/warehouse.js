...
export const entries = [
  ...
  { id: 'voice', root: 'lab', rootLabel: 'research lab', label: 'voice AI', lenses: ['AI', 'ML'],
    ...
    metric: 'NIH R01', mlabel: 'People and Robots Lab × Kamp Lab · UW–Madison · co-authored',
    headline: 'Voice-first lab assistant (SteMy)',
    narrative: "A separate engagement from the FHI internship — voice-AI research at UW–Madison. I co-authored the voice layer of SteMy, a hands-free AI lab assistant built by the People and Robots Lab (Prof. Bilge Mutlu) with the Kamp Lab (Dr. Timothy Kamp) for bench scientists: OpenAI Realtime full-duplex speech, function-calling into lab tools, and a spoken confirmation gate before any real action. A ~9-person team; my part was the voice and tool-dispatch flow. The work is part of an NIH R01 proposal that scored highly — funding anticipated.",
    ...
    tech: [
      ...
      "Context — a UW–Madison collaboration (People and Robots Lab × Kamp Lab); the broader team-built assistant also has proactive alarms, cross-run reproducibility checks, dictation, and a research-diary, ~367 tests passing. My contribution: the voice and tool-dispatch flow.",
      "Funding — part of an NIH R01 grant proposal that scored highly; funding anticipated.",
    ],
