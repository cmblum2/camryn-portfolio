...
export const entries = [
  ...
  { id: 'engine', root: 'warehouse', group: 'growth', label: 'decision engine', lenses: ['AI', 'ML', 'IB'],
    ...
    viz: 'breakeven',
    shot: { src: 'assets/shots/rag-demo.png', cap: 'Public synthetic rebuild — the live decision-desk demo (all data synthetic)' },
  ...
  { id: 'n8n', root: 'warehouse', group: 'growth', label: 'n8n alerts', step: '③ alert', lenses: ['BI', 'AI'],
    ...
    viz: 'flow-n8n',
    shot: { src: 'assets/shots/n8n-canvas.png', cap: 'The n8n workflow canvas — schedule → diff → alert (public repo)' },
  ...
  { id: 'dashboard', root: 'warehouse', group: 'bi', label: 'exec dash', lenses: ['BI', 'IB'],
    ...
    viz: 'tiles',
    shot: { src: 'assets/shots/powerbi-overview.png', cap: 'Public Power BI rebuild on synthetic data — the production app was a private Next.js dashboard' },
  ...
  { id: 'dbt', root: 'public', label: 'dbt', lenses: ['BI', 'AI'],
    ...
    viz: 'dag',
    shot: { src: 'assets/shots/dbt-lineage.png', cap: 'dbt docs — the model lineage DAG (synthetic data · public repo)' },
