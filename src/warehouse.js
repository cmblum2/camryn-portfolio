...
export const entries = [
  ...
  { id: 'voice', root: 'lab', rootLabel: 'research lab', label: 'voice AI', lenses: ['AI', 'ML'],
    ...
    tech: [
      ...
      "Context — a UW–Madison collaboration (People and Robots Lab × Kamp Lab); the broader assistant the team is building also includes proactive alarms, cross-run reproducibility checks, dictation, and a research-diary, with ~367 tests passing. My part is the voice and tool-dispatch flow.",
      "Funding — part of an active NIH R01 grant proposal that scored highly; funding anticipated.",
    ],
